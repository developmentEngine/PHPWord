...
use Devengine\PhpWord\Element\TextBreak as TextBreakElement;
...
class Container extends AbstractElement
{
     ...
     * @var string
     */
    protected $namespace = 'Devengine\\PhpWord\\Writer\\Word2007\\Element';
    ...
    public function write()
    {
        ...
        if ($writeLastTextBreak) {
            ...
            /** @var \Devengine\PhpWord\Writer\Word2007\Element\AbstractElement $writer Type hint */
