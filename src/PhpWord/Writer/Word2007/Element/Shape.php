...
use Devengine\PhpWord\Element\Shape as ShapeElement;
use Devengine\PhpWord\Style\Shape as ShapeStyle;
use Devengine\PhpWord\Writer\Word2007\Style\Shape as ShapeStyleWriter;
...
class Shape extends AbstractElement
{
     ...
     * @param \Devengine\PhpWord\Style\Shape $style
     */
